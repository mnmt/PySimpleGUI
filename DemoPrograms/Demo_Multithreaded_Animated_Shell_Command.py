...
"""
    ...
    If you have a GUI and you start a subprocess to run a shell command, the GUI essentially
    ...
    the subprocess to run async to the main program.  The main program then simply runs a loop,
